...
require (
	...
	go.opentelemetry.io/otel/trace v1.23.0 // @grafana/backend-platform
	...
	google.golang.org/api v0.167.0 // @grafana/backend-platform
	google.golang.org/grpc v1.61.1 // @grafana/plugins-platform-backend
...
require (
	...
	github.com/googleapis/gax-go/v2 v2.12.1 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.48.0 // @grafana/plugins-platform-backend
...
require (
	...
	go.opentelemetry.io/otel v1.23.0 // @grafana/backend-platform
